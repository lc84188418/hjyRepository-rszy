...
import com.hjy.cloud.domin.FebsResponse;
import com.hjy.cloud.exception.Code.Code;
...
public class GlobalExceptionHandler {
    ...
    public FebsResponse maxUploadSizeExceededException(MaxUploadSizeExceededException e) {
        log.error("上传文件过大：", e);
