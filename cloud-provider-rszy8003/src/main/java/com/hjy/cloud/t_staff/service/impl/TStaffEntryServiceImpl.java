...
import com.hjy.cloud.dictionary.dao.TDictionaryEducationMapper;
import com.hjy.cloud.dictionary.dao.TDictionaryHtlxMapper;
import com.hjy.cloud.dictionary.dao.TDictionaryNationMapper;
...
public class TStaffEntryServiceImpl implements TStaffEntryService {
    ...
    public CommonResult insert(TStaffEntry tStaffEntry) {
        tStaffEntry.setPkEntryId(IDUtils.getUUID());
        //入职时间
        //操作人
//        tStaffEntry.setOperatedPeople();
