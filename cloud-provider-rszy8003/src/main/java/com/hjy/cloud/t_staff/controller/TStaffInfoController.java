...
public class TStaffInfoController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "staffSex",value = "性别",required = true,dataType = "int",paramType = "body",example = "1"),
            ...
            @ApiImplicitParam(name = "fkDeptId",value = "部门id",required = true,dataType = "string",paramType = "body",example = "10"),
            @ApiImplicitParam(name = "fkPositionId",value = "职位id",required = true,dataType = "string",paramType = "body",example = "10"),
            @ApiImplicitParam(name = "fkWorkaddressId",value = "工作地id",required = true,dataType = "string",paramType = "body",example = "10"),
            @ApiImplicitParam(name = "entryTime",value = "入职时间",required = true,dataType = "date-time",paramType = "body",example = "10"),
            @ApiImplicitParam(name = "fkHtlxId",value = "合同类型id",required = true,dataType = "string",paramType = "body",example = "10"),
